% [X,Xn] = Xhugeo(R)
% [X,Xn] = Xhugeo(R,options)
%
% Toolbox Xvis: Extract the seven Hu moments from binary image R.
%
...
%      [X,Xn] = Xhugeo(R);      % Hu moments
%      X
%
%   See also Xgupta, Xflusser.

function [X,Xn] = Xhugeo(R,options)
