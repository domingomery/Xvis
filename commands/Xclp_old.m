% [X,Xn] = Xclp(I,R,options)
% [X,Xn] = Xclp(I,options)
%
% Toolbox Xvis: Crossing Line Profile.
%
...
%      figure;imshow(J,[])
%      figure;imshow(R)
%      [X,Xn] = Xclp(J,R,options);          % CLP features
%      Bio_printfeatures(X,Xn)
%
%   See also Xcontrast, Xharalick, Xclp, Xfourier, Xdct, Xlbp.
%
% (c) D.Mery, PUC-DCC, 2011
% http://dmery.ing.puc.cl

function [X,Xn] = Xclp(I,R,options) 
