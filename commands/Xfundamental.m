% F = Xfundamental(A,B,method)
%
% Toolbox Xvis: Fundamental Matrix.
%
...
%       m1 = A*M;                           % projection point in view 1
%       m2 = B*M;                           % projection point in view 2
%       m2'*F*m1                            % epipolar constraint must be zero

function F = Xfundamental(A,B,method)
