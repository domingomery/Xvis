...
%
%    Klette, Reinhard. Concise computer vision: an introduction into theory 
%    and algorithms. Springer Science & Business Media, 2014.
%
%   Example:
...
%      for i=1:m
%          Ri = F==i;
%          X(i,:) = Xcontrast2(I,Ri,options);     % contrast features
%      end
%      X

function [X,Xn] = Xcontrast2(I,R,options)

I = double(I);
T = abs(I-(conv2(I,ones(3,3),'same')-I)/8);
