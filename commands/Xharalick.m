% [X,Xn] = Xharalick(I,R,options)
% [X,Xn] = Xharalick(I,options)
%
% Toolbox Xvis: Haralick texture features.
%
...
%      [X,Xn] = Xharalick(I,R,options);       % Haralick features
...
function [X,Xn] = Xharalick(I,R,options)
