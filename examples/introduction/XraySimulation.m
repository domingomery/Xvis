close all
Nv = 500;                                     % Number of voxels in each direction
V  = Xobjvoxels(2,Nv,1);                      % V has Nv^3 voxels od a wheel with a flaw
...
R  = Xmatrixr3(0.5,0.5,0.4);                  % rotation
t  = [0 0 1000]';                             % translation
